...
int main()
{
    ...
    if (toupper(userChoice) == 'A')
   {
    ...
    //@author Charlson So
    //@date 9/11/2017
    //testing Bag Constructor from array
    cout<<"Testing Bag Constructor from array"<<endl;
    int ar[5]= {1,2,3,4,5};
    int size = sizeof(ar)/sizeof(*ar);
    
    LinkedBag<int>j(ar,size);
    cout<<j.getCurrentSize()<<endl;

    //end Bag Constructor Test
